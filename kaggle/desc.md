...
17. Modify kaggle/process_kaggle.py, to allow method in kaggle/config.yaml to take patch, when cfg.method is patch, set use_patch_position_loss to True, all other method fields to False.